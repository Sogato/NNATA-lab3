...
## Датасет
Датасет содержит информацию о лесных пожарах, включая такие параметры, как температура, влажность, сила ветра и площадь пожара.
...
### Целевая переменная:
* Целевая переменная (последний столбец, номер 13) изначально имеет выходная переменная имеет большой перекос в сторону 0,0.
